...
* 函数默认参数支持只在 platform 修饰的函数中定义，详见[跨平台](docs/dev-guide/source_zh_cn/multiplatform/common_platform.md)。
* common abstract class 可以被 platform sealed abstract class 实现，详见[跨平台](docs/dev-guide/source_zh_cn/multiplatform/common_platform.md)。
