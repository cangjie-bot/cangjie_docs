...
该工具的输入是 ArkTS 接口声明文件，例如后缀为 .d.ts 或 .d.ets 的文件。输出包含 BUILD.gn 文件和 src 文件夹。src 文件夹中的 cj 文件存放生成的互操作代码。此外，工具还会输出包含 ArkTS 文件所有信息的 json 文件。
