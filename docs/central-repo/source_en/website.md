...
If a user is logged into a GitCode account, they can directly authenticate and log in to the central repository. In addition to GitCode, the central repository supports login via the following methods:
*   CSDN
*   HBuilder
*   Huawei Account
*   Github
*   Gitee
*   HarmonyOS Developer Login
...
> (Add personal homepage screenshot. Currently, the personal homepage is not visible.)
...
![Personal Center](../figures/user_center.png)
