...
Please refer to the [Cangjie `SDK` Installation Guide](https://cangjie-lang.cn/en/docs?url=%2F1.0.0%2Fuser_manual%2Fsource_en%2Ffirst_understanding%2Finstall_Community.html) to install and verify your local Cangjie environment.
...
[repository.home]
  registry = "https://pkg.cangjie-lang.cn"  # Central repository URL
...
*   **`repository.home.registry`**: Configures the central repository storage address, used for upload/download communication with the central repository.
