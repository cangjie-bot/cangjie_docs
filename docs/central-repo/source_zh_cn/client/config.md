...
请参阅[仓颉 `SDK` 安装指南](https://cangjie-lang.cn/docs?url=%2F1.0.4%2Fuser_manual%2Fsource_zh_cn%2Ffirst_understanding%2Finstall_Community.html)安装并验证本地仓颉环境。
...
[repository.home]
  registry = "https://pkg.cangjie-lang.cn"  # 中心仓 url
...
- `repository.home.registry`: 配置中心仓仓库地址，用于与中心仓进行上传下载相关的通信。
