...
2. Load the script in the `Xcode` debug window command line using the command: `command script import $CANGJIE_HOME/tools-test/script/cangjie_cjdb.py`, where `$CANGJIE_HOME` should be replaced with the Cangjie installation directory.
