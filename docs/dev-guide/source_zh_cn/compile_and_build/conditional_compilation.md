...
<sup>[android target]</sup> x86_64-linux-android[31+] 中 android 后缀的数字用于指定 Android API Level。未指定数字时，默认 API Level 为 31；指定数字（如 x86_64-linux-android33）表示 Android API Level 为 33，指定的数字应大于等于26。
