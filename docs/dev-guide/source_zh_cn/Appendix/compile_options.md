...
| 本地平台 (host)      | 目标平台 (target)   | 备注                        |
| -------------------- | ------------------ | -------------------------- |
| x86_64-linux-gnu     | x86_64-windows-gnu |                            |
| aarch64-linux-gnu    | x86_64-windows-gnu |                            |
| x86_64-windows-gnu   | aarch64-linux-ohos | 仅鸿蒙版本仓颉 SDK 支持该能力 |
| x86_64-windows-gnu   | x86_64-linux-ohos  | 仅鸿蒙版本仓颉 SDK 支持该能力 |
| x86_64-apple-darwin  | aarch64-linux-ohos | 仅鸿蒙版本仓颉 SDK 支持该能力 |
| x86_64-apple-darwin  | x86_64-linux-ohos  | 仅鸿蒙版本仓颉 SDK 支持该能力 |
| aarch64-apple-darwin | aarch64-linux-ohos | 仅鸿蒙版本仓颉 SDK 支持该能力 |
