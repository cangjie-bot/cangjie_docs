...
CJO (Cangjie Object) is a binary format AST (Abstract Syntax Tree) file generated by the Cangjie compiler, primarily serving a role similar to C language header files. CJO files contain interface information, type definitions, function declarations, and other metadata of packages, used for semantic checking and type checking during compilation, without containing specific implementation code.
