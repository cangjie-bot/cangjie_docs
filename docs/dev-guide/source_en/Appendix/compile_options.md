...
| x86_64-windows-gnu  | aarch64-linux-ohos      | Only supported by the Cangjie SDK in the HarmonyOS version. |
| x86_64-windows-gnu  | x86_64-linux-ohos       | Only supported by the Cangjie SDK in the HarmonyOS version. |
| x86_64-apple-darwin | aarch64-linux-ohos      | Only supported by the Cangjie SDK in the HarmonyOS version. |
| x86_64-apple-darwin | x86_64-linux-ohos       | Only supported by the Cangjie SDK in the HarmonyOS version. |
| aarch64-apple-darwin| aarch64-linux-ohos      | Only supported by the Cangjie SDK in the HarmonyOS version. |
...
> - Only supported by the Cangjie SDK in the HarmonyOS version.
