...
Arrays are fixed-length [Collection types](../../source_zh_cn/collections/collection_overview.md), so they do not provide member functions for adding or removing elements.
